...
public class homeFragment extends Fragment implements View.OnClickListener {
    ...
    private void initNews(View v) {
        Api.getJSON("https://api.currentsapi.services/v1/latest-news?language=en&apiKey=dSIN6N3NZn8yXerCVobWMBcRpoSpzfrLqGiETykRU1MWq4Su", new ReadDataHandler(){
            @Override
            public void handleMessage(@NonNull Message msg) {
                ...
                try {
                    ...
                    for (NewsModel n : news) {
                        ...
                        item.setOnClickListener(homeFragment.this);
                        ...
                        if (n.getImage() == ""){
                            Picasso.get().load("https://cdn.cloudflare.steamstatic.com/steamcommunity/public/images/avatars/fb/fb9c36c36e54b8ca5f2e1cbd89c06574d1348af0_full.jpg").resize(136, 136).into(image);
                        }else {
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.btnSearch:
                String url = "https://api.currentsapi.services/v1/latest-news?language=en&apiKey=dSIN6N3NZn8yXerCVobWMBcRpoSpzfrLqGiETykRU1MWq4Su";
