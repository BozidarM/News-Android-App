...
public class programmingFragment extends Fragment implements View.OnClickListener {
    ...
    private void initNews(View v) {
        Api.getJSON("https://api.currentsapi.services/v1/search?language=en&category=programming&apiKey=dSIN6N3NZn8yXerCVobWMBcRpoSpzfrLqGiETykRU1MWq4Su", new ReadDataHandler(){
            @Override
            public void handleMessage(@NonNull Message msg) {
                ...
                try {
                    ...
                    for (NewsModel n : news) {
                        ...
                        item.setOnClickListener(programmingFragment.this);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.btnSearch:
                String url = "https://api.currentsapi.services/v1/search?language=en&category=programming&apiKey=dSIN6N3NZn8yXerCVobWMBcRpoSpzfrLqGiETykRU1MWq4Su";
