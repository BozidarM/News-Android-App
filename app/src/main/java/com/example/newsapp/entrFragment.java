...
public class entrFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_entr, container, false);
        initNews(v);
    ...
    private void initNews(View v) {
        Api.getJSON("https://api.currentsapi.services/v1/search?language=en&category=entertainment&apiKey=dSIN6N3NZn8yXerCVobWMBcRpoSpzfrLqGiETykRU1MWq4Su", new ReadDataHandler(){
            @Override
            public void handleMessage(@NonNull Message msg) {
                ...
                try {
                    ...
                    for (NewsModel n : news) {
                        ...
                        item.setOnClickListener(entrFragment.this);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.btnSearch:
                String url = "https://api.currentsapi.services/v1/search?language=en&category=entertainment&apiKey=dSIN6N3NZn8yXerCVobWMBcRpoSpzfrLqGiETykRU1MWq4Su";
